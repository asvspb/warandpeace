...
- **`src/`**: Исходный код.
- **`doc/`**: Документация проекта (включая этот файл, лог и планы).
- **`tools/`**: Вспомогательные скрипты и инструменты.
...
- По команде "ОК":
    Обновить план: devAI/PLANNING.md
    Обновить логи: devAI/developer_log.md
    Сохранить в Git: по правилам выше
