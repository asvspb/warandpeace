...
- [SESSION_STATS_PLAN_RU.md](SESSION_STATS_PLAN_RU.md)
  - Цель: сбор и отображение статистики по текущей сессии.
  - Статус: план составлен.


## Порядок реализации (приоритеты)

1. [WIREGUARD_INTEGRATION_PLAN_RU.md](WIREGUARD_INTEGRATION_PLAN_RU.md)
   - Почему: Защищенный egress, снижение рисков блокировок.
   - Сложность: Средняя; в основном DevOps.
2. [PY312_MIGRATION_PLAN.md](PY312_MIGRATION_PLAN.md)
   - Почему: Актуальный стек = безопасность и производительность.
   - Сложность: Низкая; обновление образа и зависимостей.
3. [POSTGRES_MIGRATION_PLAN_RU.md](POSTGRES_MIGRATION_PLAN_RU.md)
   - Почему: Масштабирование и надежность, основа будущих фич.
   - Сложность: Высокая; рефакторинг слоя данных (БД v3/Alembic).
4. [API_KEYS_HEALTH_PERSISTENCE_PLAN_RU.md](API_KEYS_HEALTH_PERSISTENCE_PLAN_RU.md)
   - Почему: Снижение сбоев суммаризации за счет выбора здоровых ключей.
   - Сложность: Средняя; изменения схемы и логики выбора.
5. [BOT_MENU_AND_DEBUG_FEATURES_PLAN_RU.md](BOT_MENU_AND_DEBUG_FEATURES_PLAN_RU.md)
   - Почему: Улучшение UX и поддерживаемости.
   - Сложность: Низкая.
6. [ARCHIVE_SYNC_AND_DASHBOARD_PLAN_RU.md](ARCHIVE_SYNC_AND_DASHBOARD_PLAN_RU.md)
   - Почему: Наблюдаемость и контроль данных.
   - Сложность: Средняя; фоновая синхронизация + дашборд.
7. [MEDIA_FROM_ORIGINAL_SOURCE_PLAN_RU.md](MEDIA_FROM_ORIGINAL_SOURCE_PLAN_RU.md)
   - Почему: Качество контента.
   - Сложность: Высокая; парсинг и устойчивость.
8. [SUMMARIZATION_CONTROL_AND_TAGGING_PLAN_RU.md](SUMMARIZATION_CONTROL_AND_TAGGING_PLAN_RU.md)
   - Почему: Контроль качества выдачи.
   - Сложность: Средняя.
9. [ZETTELKASTEN_AND_RELATED_ARTICLES_PLAN_RU.md](ZETTELKASTEN_AND_RELATED_ARTICLES_PLAN_RU.md)
    - Почему: R&D-функция уровня AI-платформы.
    - Сложность: Очень высокая.
10. **[РЕАЛИЗОВАНО]** [CLOUD_BACKUP_PLAN_RU.md](CLOUD_BACKUP_PLAN_RU.md)
