...
Далее, ответь на вопросы: "что у нас по планам следущее? на каком этапе мы сейчас?". Планы можно уточнить у пользователя, после ознакомления с папкой doc/ и просмотра статуса гит и списка последних измененных файлов.
